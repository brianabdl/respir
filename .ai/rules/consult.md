...
## Anemia screening removed — cough/TB only

Anemia screening was intentionally removed end-to-end: no consult.anemia route, no AnalyseAnemia/AnemiaCaptureRequest, no /v1/vision/anemia or anemia model adapters, no anemia.analysis event, no palm/eye/nail auto-capture cues in liveSystemInstruction, and consult_captures no longer has analysis/risk_level/analyzed_at. TB screening is cough-only. Do not reintroduce anemia capture or vision-screening plumbing.
