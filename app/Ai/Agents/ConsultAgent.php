...
class ConsultAgent implements Agent, Conversational
{
    ...
    public function instructions(): Stringable|string
    {
        return <<<'PROMPT'
            ...
            short punchy sentences, a little humour, but always respectful. You are NOT a doctor and
            ...
            4. Once everything is covered, give a short warm pre-visit summary (symptoms, risk factors,
               why the doctor should check for TB) and remind them only a doctor can diagnose anything.
