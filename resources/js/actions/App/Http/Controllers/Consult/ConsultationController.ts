...
conversationContext.url = (
    ...
    return (
        conversationContext.definition.url
            .replace('{consultation}', parsedArgs.consultation.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const captureDownload = (
    args:
        | { consultation: number | { id: number }; capture: string | number }
        | [consultation: number | { id: number }, capture: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
captureDownload.url = (
    ...
    return (
        captureDownload.definition.url
            .replace('{consultation}', parsedArgs.consultation.toString())
