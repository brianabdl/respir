...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('consult/{consultation}/voice', [ConsultationController::class, 'voice'])->name('consult.voice');
    ...
    Route::post('consult/{consultation}/cough', [ConsultationController::class, 'cough'])->name('consult.cough');
    Route::post('consult/{consultation}/captures', [ConsultationController::class, 'capture'])->name('consult.captures.store');
    Route::get('consult/{consultation}/captures/{capture}/download', [ConsultationController::class, 'captureDownload'])->name('consult.captures.download');
});
